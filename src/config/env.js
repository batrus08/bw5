...
const ADMIN_API_TOKEN = assertNonEmpty('ADMIN_API_TOKEN', process.env.ADMIN_API_TOKEN);
...
const SHEET_SYNC_SECRET = process.env.SHEET_SYNC_SECRET || process.env.SHEET_SECRET || '';
const SHEET1_HMAC_SECRET = process.env.SHEET1_HMAC_SECRET || '';
const SHEET2_HMAC_SECRET = process.env.SHEET2_HMAC_SECRET || '';
const SHEET2_WEBAPP_URL = process.env.SHEET2_WEBAPP_URL || '';
...
const TOTP_STEP_SEC = Number(process.env.TOTP_STEP_SEC || 30);
...
const CANVA_TEAM_ID = process.env.CANVA_TEAM_ID || '';

module.exports = {
  TELEGRAM_BOT_TOKEN, ADMIN_CHAT_ID, ADMIN_API_TOKEN, WEBHOOK_SECRET_PATH, DATABASE_URL, ENCRYPTION_KEY,
  PUBLIC_URL,
  WA_ACCESS_TOKEN, WA_VERIFY_TOKEN, WA_PHONE_NUMBER_ID, WA_API_BASE, WA_APP_SECRET,
  SHEET_MODE, SHEET_CSV_URL, SHEET_SECRET, SHEET_SYNC_SECRET, SHEET1_HMAC_SECRET, SHEET2_HMAC_SECRET, SHEET2_WEBAPP_URL, SHEET_POLL_MS,
  OTP_TTL_SEC, OTP_MAX_ATTEMPT, TOTP_STEP_SEC,
  ...
  CGPT_TEAM_URL, CANVA_TEAM_URL, CANVA_API_TOKEN, CANVA_TEAM_ID,
};
