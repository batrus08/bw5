...
try{ const b=Buffer.from(ENCRYPTION_KEY,'base64'); if(b.length!==32) throw new Error('invalid length'); }catch(e){ throw new Error('ENCRYPTION_KEY must be base64 of 32 bytes'); }
...
module.exports = {
  TELEGRAM_BOT_TOKEN, ADMIN_CHAT_ID, WEBHOOK_SECRET_PATH, DATABASE_URL, ENCRYPTION_KEY, PUBLIC_URL,
  ...
  RATE_LIMIT_EVENTS_PER_MIN, RATE_LIMIT_WA_PER_MIN,
};
