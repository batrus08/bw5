...
function startWorkers(){ setInterval(expireOrders, minutes(1)); setInterval(remindPayments, minutes(1)); setInterval(checkStockAndPause, minutes(5)); if(SHEET_POLL_MS>0){ setInterval(syncAccountsFromCSV, SHEET_POLL_MS); } console.log('Workers started.'); }
